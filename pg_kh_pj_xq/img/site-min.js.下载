var pop = {
    ...
    loadGallery: function (e, a) {
        $.ajax({
            url: e, data: {trans_data: a}, dataType: "html", type: "post", success: function (e, a) {
        ...
        $.ajax({
            url: e, data: {postid: a, lang: n}, dataType: "html", type: "post", success: function (e, a) {
                function n() {
                ...
                if ($("#news-modal .cont").hide().html(e), $("#news-modal .cont .anim_emt").filter(":last").removeClass("anim_emt"), $("#news-modal .cont").find("img").length > 0) {
                    ...
                    var t = $("#news-modal .cont img").filter(":first"), i = new Image;
    ...
    setCookie: function (e, a) {
        var n = 30, o = new Date, t = "localhost";
    ...
    init: function () {
        function e() {
            var e = $(window).scrollTop() + 140, a = $("#body").offset().top;
...
var swiper = {
    init: function () {
        $(".swiper-container").each(function (e, a) {
            var n = $(this), o = n.is(".head-swiper") ? 1600 : 800, t = n.is(".head-swiper") ? !1 : !0, i = n.is(".autoplay") ? 5e3 : 0, s = n.is(".loop") ? !0 : !1, l = new Swiper(n, {
                ...
                onSetTranslate: function (e, a) {
                    for (var n = 0; n < e.slides.length; n++) {
                        var o = e.slides[n], t = o.progress, i = 1 - Math.min(Math.abs(t), 1), s = 1 + Math.min(Math.abs(.2 * t), .2), l = 50, r = t * l;
    ...
    resetImg: function () {
        function e() {
            $("#gallery").find(".imgbg").each(function () {
                var e = $(this), a = e.data("imgw"), n = e.data("imgh"), o = $(window).width(), t = $(window).height();
    ...
    init: function () {
            ...
            $("body").removeClass("loading"), $("#pageloader").addClass("hide"), ics && animElements.init(), setTimeout(function () {
                if ($("#pageloader").remove(), $(".loop").length && $('.loop [data-swiper-slide-index="0"]').each(function (e) {
                    ...
                    e.find("path").each(function () {
                        var e = $(this)[0], a = $(this), n = a.data("delay") > 0 ? a.data("delay") : 0;
        ...
        var n = $("img:not(.swiper-lazy)").length, o = $("[data-proload]").length, t = n + o, i = 1, s = 1;
        0 == t && a(), $("img").each(function () {
            ...
            var n = $(this), o = new Image, t = n.data("proload");
    ...
    init: function () {
        function e(e, a) {
            if (e.parent().removeAttr("style"), e.removeAttr("style"), $(window).width() >= 768) {
                var n = parseInt(e.css("padding-left")), o = Math.round(e.parent().width() * a - 2 * n);
                e.each(function () {
                    var e = $(this);
    ...
    init: function () {
        var e = themeurl + "/ajax-store.php", a = $("#store-select").children("option:selected").val();
