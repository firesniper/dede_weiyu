;(function( $, window, undefined ) {
  ...
  TilesSlider.prototype = {
    ...
    _getRandom: function ( )
    {
      ...
      var randomAnim = 
               ...
               + '-anim' ;
      return {
        "ramdomNormal" : ramdomNormal ,
        "randomAnim"  : randomAnim
      } ;
    } ,
    _generateTiles: function( $img ) {

      var ramdomNormal = this._getRandom (  ) [ 'ramdomNormal' ]  ;
      var self = this
        , o = self.opts
        , tiles = [], $tiles
    ...
    {
      var randomAnim = this._getRandom (  ) [ 'randomAnim' ] ;
    ...
    _resetTiles: function( $wrap ) {
      $wrap.find('.tiles-tile').removeClass
      ( 
        this.klassAnim 
        // "tiles-left-anim"
      )
  ...
  // jQuery plugin:
  var eleChangeSize = function ( element )
  {
    var winWidth = window.innerWidth ;
    var picHeight = winWidth * 785/1920 ;
    var screenWidth = screen.width ;
    element = element ? element : document.getElementsByClassName ( "slider" ) [ 0 ] ;
    element.style.width = screen.width + "px" ;
    element.style.height = picHeight + "px" ;
    return element ;
  } ;
...
(
  ...
  function () 
  {
    ...
    {
      $( '.slider-wrap' ).width ( screen.width + 'px' ) ;
